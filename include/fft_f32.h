...
/**
 * @brief Performs in-place Radix-2 FFT computation (skips bit-reversal).
 * 
 * @param pData Pointer to the pre-shuffled complex data array.
...
/**
 * @brief Performs in-place Radix-2 FFT on a complex f32 array (includes bit-reversal).
 * 
 * @param pData Pointer to the complex data array.
 * @param n Length of the FFT (must be a power of 2).
 * @param isInverse 0 for forward FFT, 1 for inverse FFT.
